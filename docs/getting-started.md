...
* **How to do it:** Just double-click the OSRO Tools shortcut. Windows will automatically show a UAC prompt asking for permission. Click **Yes**.
...
When you open OSRO Tools, you will see a top bar and a side menu.
1. **Top Bar:** This displays your character's live HP, SP, and your global toggle hotkey.
2. **Side Menu:** This allows you to navigate between all the different feature tabs, like **Autopot** and **Autobuff**.
...
1. Click the **Profiles** tab on the left side menu.
...
![Screenshot of the Profiles tab when first opened](images/getting-started-profile.png)
